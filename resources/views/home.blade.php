            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <div class="btn-box" style="display:flex; gap:15px; flex-wrap:wrap;">
                        ...
                        <a href="+19519004840" class="theme-btn btn-one" style="background:#0b3752; color:#ffffff; border:2px solid #fff;">
                            Call Dispatch: (951) 900-4840
                        </a>
                    </div>
            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <div class="btn-box" style="display:flex; gap:15px; flex-wrap:wrap;">
                        ...
                        <a href="(951) 900-4840" class="theme-btn btn-one" style="background:#0b3752; color:#ffffff; border:2px solid #fff;">
                            Call Dispatch: (951) 900-4840
                        </a>
                    </div>
...
<section class="chooseus-section centred pt_120 pb_90">
    <div class="bg-layer parallax-bg" data-parallax='{"y": 100}' style="background-image: url(assets/images/background/back1.png);"></div>
    ...
    <div class="auto-container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <img src="assets/images/resource/ambulance-5.png" alt="Coverage Map" style="width:100%; border-radius:12px;">
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                    <div class="funfact-block-one">
                        <div class="inner-box">
                            <div class="count-outer">
                                <span class="odometer" data-count="30">00</span>&nbsp;<span class="symble">+</span>
                            </div>
                            <p>Operation Bases</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                    <div class="funfact-block-one">
                        <div class="inner-box">
                            <div class="count-outer">
                                <span class="odometer" data-count="100">00</span>&nbsp;<span class="symble">+</span>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                    <div class="funfact-block-one">
                        <div class="inner-box">
                            <div class="count-outer">
                                <span class="odometer" data-count="300">00</span>&nbsp;<span class="symble">+</span>
                            </div>
                            <p>Frontline Staff</p>
                        </div>
                    </div>
